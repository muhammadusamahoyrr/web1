...
export const Ic = {
  ...
  clock:  (c) => ic(c, <><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></>),
  ...
  pin:    (c) => ic(c, <><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /></>),
};
